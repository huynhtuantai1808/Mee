...
function animate() {
  ...
  if (!introStarted) {
    ...
    scene.traverse(obj => {
      ...
      } else if (obj !== planet && obj !== centralGlow && obj !== hintIcon && obj.type !== 'Scene' && !obj.parent.isGroup && obj.name !== 'greeting-text') {
        if (obj.material && obj.material.opacity !== undefined) {
    ...
    scene.traverse(obj => {
      if (!(obj.userData.isTextRing || (obj.parent && obj.parent.userData && obj.parent.userData.isTextRing) || obj === planet || obj === centralGlow || obj.type === 'Scene' || obj.name === 'greeting-text')) {
        if (obj.material && obj.material.opacity !== undefined) {
          obj.material.transparent = true;
      ...
      if (obj.material && obj.material.color) {
        // Đối với MeshPhongMaterial, bạn cần chỉnh sửa màu của từng vật liệu trong mảng
        if (Array.isArray(obj.material)) {
            obj.material.forEach(mat => {
                if (mat.color) mat.color.set(0xffffff); // Đặt màu trắng cho các vật liệu khác
            });
        } else {
...
createHintText();
createGreetingText(); // Gọi hàm tạo lời chúc 3D
